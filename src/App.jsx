  ...
  return (
    <div className="app-container">
      <SignedOut>
        {/* Desktop Background */}
        <div 
          className="hidden md:flex items-center justify-center min-h-screen bg-background relative p-4"
          style={{
        ...
        {/* Mobile Background */}
        <div 
          className="flex md:hidden items-center justify-center min-h-screen bg-background relative p-4"
          style={{
        ...
        >
          ...
          {/* Content */}
          <div className="w-full max-w-md px-4 sm:px-6 py-16 relative z-10 -mt-20">
            <div className="text-center mb-6 sm:mb-8">
              <div className="flex justify-center mb-3 sm:mb-4">
                <div className="h-12 w-12 sm:h-16 sm:w-16 rounded-xl flex items-center justify-center shadow-lg">
                  <span className="text-white font-bold text-2xl sm:text-3xl"></span>
